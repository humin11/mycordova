// Generated on 2015-04-18 using generator-angular-cordova 0.0.1
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        shell: {
            iossimstart: {
                command: 'ios-sim launch platforms/ios/build/myCordova.app --exit' + (device.family !== 'default' ? ' --family ' + device.family : ''),
                options: {
                    stdout: true
                }
            },
